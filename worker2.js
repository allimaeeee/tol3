...
export default {
  ...
  "factoring for quadratic equations. Be encouraging but verify they explain WHY factoring " +
  "is preferred, not just HOW to factor. Return ONLY valid JSON (no markdown, no code blocks, " +
  "no extra text).";
...
const userPrompt =
  ...
  "why factoring is the best method for x² + x - 6 = 0, such as:\n" +
  "- The equation has simple, obvious integer factors: (x + 3)(x - 2) = 0\n" +
  "- Factors of -6 that sum to 1 are immediately recognizable (3 and -2)\n" +
  "- Factoring is fastest when patterns are clear\n" +
  "- The leading coefficient is 1, making factoring straightforward\n\n" +
  "Award 'Not quite right' if they can factor correctly but don't explain why it's the preferred method.\n" +
  "Award 'Incorrect' if they show misconceptions or only describe steps without reasoning.\n\n" +
