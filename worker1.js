...
export default {
  async fetch(request, env) {
    ...
    */
    ...
    "the quadratic formula. Be encouraging but precise. Award points for strategic reasoning " +
    "about WHY this method is appropriate, not just HOW to use it. Return ONLY valid JSON " +
    ...
    const userPrompt =
      ...
      "why the quadratic formula is appropriate for m² - 5m - 14 = 0, such as:\n" +
      "- Factoring is not immediately obvious (finding factors of -14 that sum to -5 requires trial-and-error)\n" +
      "- The quadratic formula works systematically for any quadratic\n" +
      "- It's reliable when factoring patterns aren't clear\n\n" +
      "Award 'Not quite right' if they mention using the formula but don't explain WHY it's better here.\n" +
      "Award 'Incorrect' if they show misconceptions or focus only on procedure.\n\n" +
