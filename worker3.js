...
export default {
  async fetch(request, env) {
    ...
    */
    ...
    //Q2: Factoring
    const systemPrompt =
  "You are a mathematics education expert evaluating student understanding of when to use " +
  "completing the square. Be encouraging but verify they understand strategic advantages. " +
  "Check that they explain WHY this method is useful, not just HOW to complete the square. " +
...
const userPrompt =
  ...
  `Learner response:\n${responseText}\n\n` +
  "Evaluate this response. Award 'Correct' if the student explains at least TWO reasons " +
  "why completing the square is appropriate for x² + 14x = -24 (or x² + 14x + 24 = 0), such as:\n" +
  "- The middle coefficient (14) is even, so (14/2)² = 49 creates a perfect square cleanly\n" +
  "- This method reveals vertex form: (x + 7)² = 25\n" +
  "- Completing the square shows the structure of the parabola\n" +
  "- It's a systematic approach even though this equation could also be factored\n\n" +
  "Award 'Not quite right' if they can describe the process but don't explain strategic advantages.\n" +
  "Award 'Incorrect' if they show misconceptions or only list procedural steps.\n\n" +
...
function isAllowedOrigin(origin) {
  ...
  if (origin === "https://allimaeeee.github/tol3") return origin;
